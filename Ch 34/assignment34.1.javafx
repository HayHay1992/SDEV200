...
public class StaffDatabase {
 ...
 public void init() {
  ...
  jPanel1.setBorder(new TitledBorder("Staff"));
  ...
  JButton jButton1 = new JButton("View Staff");

  jPanel2.add(jButton1);

  JButton jButton2 = new JButton("Insert New Staff");

  jPanel2.add(jButton2);

  JButton jButton3 = new JButton("Update Staff");

  jPanel2.add(jButton3);

  JButton jButton4 = new JButton("Clear Staff");
...
try {
 ...
 public static void main(String[] args) {
  ...
  StaffDatabase applet = new StaffDatabase();

  JFrame frame = new JFrame();

  frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

  frame.setTitle("StaffDatabase");
